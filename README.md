...
## Compilation
**Le projet utilise [tauri](https://v2.tauri.app/)**

Tauri permet d'embarquer une webview (mini-navigateur) dans une application desktop. Il charge alors la page web du [client](https://extinction-minijeux.fr/client)
...
**V2.0.0 - 01/02/2026**
- Migration complète vers Tauri v2
